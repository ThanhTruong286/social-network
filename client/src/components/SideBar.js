                ...
                <div class="nav-content">
                    <div class="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2 mt-2">
                        ...
                        <ul class="mb-1 top-content">
                            ...
                            <li><a href="default.html" class="nav-content-bttn open-font"><i class="fa-solid fa-tv btn-round-md bg-blue-gradiant me-3"></i><span>Newsfeed</span></a></li>
                            <li><a href="default-badge.html" class="nav-content-bttn open-font"><i class="fa-solid fa-medal btn-round-md bg-red-gradiant me-3"></i><span>Badges</span></a></li>
                            ...
                            <li><a href="user-page.html" class="nav-content-bttn open-font"><i class="fa-solid fa-user btn-round-md bg-primary-gradiant me-3"></i><span>Author Profile </span></a></li>
                        </ul>
                    </div>
